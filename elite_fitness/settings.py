"""
Django settings for elite_fitness project.
...
WSGI_APPLICATION = 'elite_fitness.wsgi.application'
...
# Define the directory where collectstatic will collect static files during deployment
...
# if 'USE_AWS' in os.environ:
#     # Bucket Config
#     AWS_STORAGE_BUCKET_NAME = 'elite-fitness-app'
...
AWS_STORAGE_BUCKET_NAME = 'elite-fitness-app'
AWS_ACCESS_KEY_ID = 'AKIA3FLD43TIQGTIERFW'
AWS_SECRET_ACCESS_KEY = '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'
AWS_S3_CUSTOM_DOMAIN = f'{AWS_STORAGE_BUCKET_NAME}.s3.amazonaws.com'
...
if 'DEVELOPMENT' in os.environ:
    ...
    DEFAULT_FROM_EMAIL = 'amyleighsawyer97@gmail.com'
else:
    EMAIL_BACKEND = 'django.core.mail.backends.smtp.EmailBackend'
    EMAIL_USE_TLS = True
    EMAIL_PORT = 587
    EMAIL_HOST = 'smtp.gmail.com'  # Move this line here
